...
import com.actor.sample.database.ItemEntity.MapConverter;
...
public class ItemEntityDao extends AbstractDao<ItemEntity, Long> {
    ...
    public ItemEntity readEntity(Cursor cursor, int offset) {
        ItemEntity entity = new ItemEntity( //
            ...
            cursor.isNull(offset + 5) ? null : paramsConverter.convertToEntityProperty(cursor.getString(offset + 5)) // params
        );
        return entity;
    }
