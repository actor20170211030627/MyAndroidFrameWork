...
public class SelectFileActivity extends BaseActivity<ActivitySelectFileBinding> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        viewBinding.recyclerView21.addItemDecoration(decoration);
        viewBinding.recyclerView22.addItemDecoration(decoration);
        viewBinding.recyclerView23.addItemDecoration(decoration);
        viewBinding.recyclerView21.setAdapter(mPictureAdapter);
        viewBinding.recyclerView22.setAdapter(mVideoAdapter);
        viewBinding.recyclerView23.setAdapter(mAudioAdapter);
