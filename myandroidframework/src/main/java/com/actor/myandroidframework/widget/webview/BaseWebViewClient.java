...
public class BaseWebViewClient extends WebViewClient {
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {//页面开始加载
        ...
        LogUtils.formatError("开始加载网页: url = %s", true, url);
    }

    @Override
    public void onPageFinished(WebView view, String url) {//页面加载完成
        super.onPageFinished(view, url);
        LogUtils.formatError("网页加载完成: url = %s", true, url);
    }
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        LogUtils.formatError("跳转网页: url=%s", true, url);
    ...
    public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
        LogUtils.formatError("跳转网页: request=%s", true, request);
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
        ...
        LogUtils.formatError("拦截器, shouldInterceptRequest: Uri=%s, isForMainFrame=%b, isRedirect=%b, " +
                "hasGesture=%b, Method=%s, RequestHeaders=%s", true, request.getUrl(),
                request.isForMainFrame(), request.isRedirect(), request.hasGesture(),
...
//        return new WebResourceResponse("text/html", "utf-8", new ByteArrayInputStream(response.getBytes()));
    ...
    public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
        LogUtils.formatError("加载网页发生证书认证错误: handler=%s, error=%s", true, handler, error);
...
//        handler.proceed();//忽略错误
    ...
    public void onReceivedHttpError(WebView view, WebResourceRequest request, WebResourceResponse errorResponse) {
        ...
        LogUtils.formatError("Http请求错误, onReceivedHttpError, request: Uri=%s, isForMainFrame=%b," +
                        " isRedirect=%b, hasGesture=%b, Method=%s, RequestHeaders=%s", true,
        ...
        LogUtils.formatError("Http请求错误, onReceivedHttpError, errorResponse: StatusCode=%d, Encoding=%s, " +
                        "MimeType=%s, ReasonPhrase=%s, ResponseHeaders=%s, Data=%s", true,
    ...
    public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
        ...
        LogUtils.formatError("收到错误, onReceivedError, error: ErrorCode=%d, Description=%s", true,
