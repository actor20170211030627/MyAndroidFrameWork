...
public class GaoDeUiSettingUtils {
     ...
     * 定位按钮是否显示, 默认false
     */
    public static void setMyLocationButtonEnabled(@NonNull AMap aMap, boolean enabled) {
        aMap.getUiSettings().setMyLocationButtonEnabled(enabled);
    }

    //设置罗盘, 指南针是否显示, 默认false
    public static void setCompassEnabled(@NonNull AMap aMap, boolean enabled) {
        aMap.getUiSettings().setCompassEnabled(enabled);
    }

    //设置"比例尺"是否显示, 默认false
    public static void setScaleControlsEnabled(@NonNull AMap aMap, boolean enabled) {
     ...
     * @see GaoDe3DMapUtils#moveCamera(AMap, LatLng, float, boolean);
     */
    public static void setIndoorSwitchEnabled(@NonNull AMap aMap, boolean enable) {
        aMap.getUiSettings().setIndoorSwitchEnabled(enable);
    }

    //"缩放按钮"是否显示, 默认true
    public static void setZoomControlsEnabled(@NonNull AMap aMap, boolean enable) {
     ...
     */
    public static void setZoomPosition(@NonNull AMap aMap, int position) {
     ...
     */
    public static void setLogoPosition(@NonNull AMap aMap, int position) {
